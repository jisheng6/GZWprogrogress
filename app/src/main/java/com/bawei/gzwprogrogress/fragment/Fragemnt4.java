...
public class Fragemnt4 extends Fragment{
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(uid==0) {
            ...
            View view1 = inflater.inflate(R.layout.fragment4, container, false);
            Button tiao = view1.findViewById(R.id.tiaaa);
            ...
            View view = inflater.inflate(R.layout.fragemnt_4, container, false);
            return view;
        }
    }
}
